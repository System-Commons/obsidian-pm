...
/**
 * A self-contained picture of a view at one moment: the project with every task, the
 * view state the reader started from, and the icon glyphs the page needs, so nothing
